...
<body>
    <?php
        $notificacao = Notificacao::count_notificacao_novas('voluntario');
    ?>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu" class="nav nav-list">
            <li id="1A">{{ HTML::decode(HTML::link_to_action('Voluntario@Voluntario', '<i class="icon-home"></i> <span>Home</span>')) }}</li>
        </ul>
    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#notificar').click(function(e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: BASE+'/voluntario/notificacao',
                    beforeSend: function() {
